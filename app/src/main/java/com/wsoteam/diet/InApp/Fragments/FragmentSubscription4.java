...
public class FragmentSubscription4 extends Fragment
  ...
  public static FragmentSubscription4 newInstance(Box box) {
    ...
    FragmentSubscription4 fragment =
        new FragmentSubscription4();
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    View view = inflater.inflate(R.layout.fragment_subscription_4, container, false);
    ...
    priceTextView.setText(setColor(R.string.prem_4_price, "#ef7d02", 25, 42 ));
  ...
  @OnClick({R.id.mcvYear, R.id.mcvMonth})
